...
public class AddonServiceImpl implements AddonService {
    ...
    private Addon createAddon(String addonName, String data, double addonPrice, String addonDetails, String operatorName) {
    ...
    public boolean createAddon(Addon addon) {
        return addonRepository.save(addon) != null ? true : false;
    }
    ...
    public boolean deleteAddon(Long id) {
        if (addonRepository.findById(id).isPresent()) {
